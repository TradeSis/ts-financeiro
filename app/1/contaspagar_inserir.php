...
if (isset($LOG_CAMINHO)) {
    ...
    $identificacao = date("dmYHis") . "-PID" . getmypid() . "-" . "contaspagar_inserir";
    if (isset($LOG_NIVEL)) {
        if ($LOG_NIVEL >= 1) {
...
if (isset($jsonEntrada['numeroDocumento'])) {
    ...
    $sql = "INSERT INTO `contaspagar`( `numeroDocumento`, `idCliente`, `dataVencimento`, `dataEmissao`, `valorPagar`, `idContaCorrente`, `valorAberto`, `dataLiquidacao`, `idNotaServico`, 
    `idCategoria`, `condicao`) VALUES ('$numeroDocumento','$idCliente','$dataVencimento','$dataEmissao','$valorPagar','$idContaCorrente','$valorAberto','$dataLiquidacao','$idNotaServico','$idCategoria','$condicao')";
