                            ...
                            <div class="col-md" style="margin-top: 25px;">
                                ...
                                <div class="row">
                                    <div class="col-md form-group" style="margin-top: -40px;">
                                        ...
                                        <input type="number" class="data select form-control" name="valorReceber"
                                            required>
                                    </div>
                                    <div class="col-md form-group" style="margin-top: -40px;">
                            ...
                            <div class="col-md" style="margin-top: 25px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group-select" style="margin-top: -20px;">
                                        ...
                                        <input type="text" class="data select form-control" name="idCR" id="idCR"
                                            style="display: none;">
                                    </div>
                                </div><!--fim row 1-->
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md form-group" style="margin-top: -40px;">
                                        <label class="labelForm">valorReceber</label>
                                        <input type="number" class="data select form-control" id="valorReceber"
